...
const API_KEY = "cec81fe121684ffb96c213435252803"; // API key
...
locationButton.addEventListener("click", () => {
  navigator.geolocation.getCurrentPosition(
    ...
    () => {
      alert("Acesso à localização negado. Por favor, ative a permissão de localização no navegador.");
    }
  );
});

// Initial weather request for London as the default city
setupWeatherRequest("Salvador");